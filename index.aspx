...
.message:hover .text {
 ...
 <div class="container">
   ...
   <%-- <div class="padding">--%>
    <div class="row c">
        ...
        <div class="col" id="a1">
 <asp:ImageButton ID="img1" CssClass="img-fluid" runat="server"/> 
            <br />
 <asp:Label ID="lblimg1" runat="server" Text=""></asp:Label>
        ...
        <div class="col" id="a2">
             <asp:ImageButton ID="img2" CssClass="img-fluid" runat="server" OnClick="img2_Click"/>
            <br />
        ...
        <div class="col" id="a3">
             <asp:ImageButton ID="img3" CssClass="img-fluid" runat="server"/>
            <br />
...
<asp:Label ID="lblimg3_2" runat="server" Text="Label"></asp:Label>
 ...
 <div class="row">
     <div class="col" id="a4">
            <asp:ImageButton ID="img4" CssClass="img-fluid" runat="server"/> 
         <br />
         <br />
     ...
     <div class="col" id="a5">
          <asp:ImageButton ID="img5" CssClass="img-fluid" runat="server"/>
         <br />
         <br />
     ...
     <div class="col" id="a6">
          <asp:ImageButton ID="img6" CssClass="img-fluid" runat="server"/>
         <br />
         <br />
